...
| `enclosure/` | Enclosure design system (CSS, Vue 3 library, theme generator) | `enclosure/CLAUDE.md` |
...
- `enclosure/DESIGN.md` — complete design spec: seed-driven color system, typography hierarchy, component catalog, elevation model, do's and don'ts
- `enclosure/PRODUCT.md` — product framing and anti-references for the design system
