...
The Mirror marketing site is built with [Astro](https://astro.build), but you don't need to know Astro to make most changes. Almost all visible content lives in plain text files.

## Quick start

```bash
git clone https://github.com/vendinois/mirror.git
cd website
npm install
...
The design tokens (colors, border radii) are at the top. These match the Mirror app's design system. Change them here and the whole site updates.
...
| Styling | Tailwind CSS v4 | Same stack as the Mirror app itself |
