...
* **Total Data Ownership:** Data is local-first and zero-knowledge by default; nothing leaves the user's device unless explicitly authorized.
* **Anti-Telemetry / Zero-Collection:** The brand proudly practices zero or bare-minimum data collection, transforming privacy from a compliance checkbox into a premium design feature.
* **Bring Your Own Key (BYOK):** For integrations utilizing AI or third-party architectures, users supply their own API keys, removing corporate mediation and data harvesting.
