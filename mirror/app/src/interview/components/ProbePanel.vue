...
const canSubmit = computed(() => !props.isWorking && answer.value.trim().length > 0);
...
<template>
  <div class="nc-plate relative flex flex-col gap-4">
    <span class="nc-facet">PROBING · {{ facetLabel }}</span>

    <div class="relative flex flex-col gap-4">
      <!-- Fixed-height question box: long questions scroll inside it so the textarea + footer below never shift as the question changes. -->
