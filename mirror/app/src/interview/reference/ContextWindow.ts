// Per-model context-window sizes, used to decide when pasted input must be
// digested before it can be sent. Reference data, not a domain model
// (CONVENTIONS 1.2 / 6.10).
