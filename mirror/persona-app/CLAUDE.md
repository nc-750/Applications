...
Cross-platform desktop + PWA that wraps the persona-interview, persona-insight, and persona-profile skills with a bring-your-own-AI model.
...
- **One persona per device** — stored under key `"default"` in IndexedDB
