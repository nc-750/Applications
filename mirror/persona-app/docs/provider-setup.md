...
5. In Persona Settings, select **OpenAI**, paste the key.
...
5. In Persona Settings, select **Anthropic**, paste the key.
...
4. Copy the key.
5. In Persona Settings, select **Mistral**, paste the key.
...
3. In Persona Settings, select **OpenAI-compatible**.
...
4. In Persona Settings:
   - Select **OpenAI-compatible**
   - Endpoint: `http://localhost:11434/v1`
   - API key: anything (Ollama ignores it, but the field can't be empty — type `ollama`)

> **Note:** Local models produce less consistent structured output. Persona has a fallback path that handles this, but synthesis may take an extra attempt. Use a model with strong instruction-following (Llama 3.2 7B+, Mistral 7B+, or Gemma 3 12B+).
...
Once you've set a provider and API key, click **Fetch models** in Settings to load the list of models available to your account. You can select from the list or type any model name directly — Persona doesn't restrict you to the list.
