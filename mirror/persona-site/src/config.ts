...
export const SITE = {
  ...
  description:
    "Persona interviews you with AI, finds patterns you missed, and produces a private insight document and a polished public profile. Nothing leaves your device.",
  url: "https://persona.vendinois.com",
...
export const DOWNLOAD = {
  githubReleases: "https://github.com/vendinois/persona/releases",
  pwaUrl: "https://persona.vendinois.com/app",
...
export const FOOTER_LINK_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "GitHub", href: "https://github.com/vendinois/persona" },
    ],
  },
];
...
export const HOW_IT_WORKS_STEPS = [
  {
    ...
    description:
      "Drop your CV, LinkedIn export, or just write freely. PDF, Markdown, text, HTML, JSON: Persona extracts it all. The more you give, the richer the interview.",
  },
  {
    step: 2,
