...
description: >-
  ...
  DECISION NEEDED. Read-only — decomposes, never plans or builds. Invoked by /nc-750 map.
...
1. Load and follow the `nc-750-map` skill — it is your complete doctrine and procedure.
...
3. Ground the decomposition in the real codebase: Read/Grep/Glob the actual layers, modules, and
   ...
   expands into a buildable brief with no reshaping. You have no Bash — you read, you do not run.
...
nc-750-challenge on the result.
