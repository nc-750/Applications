...
description: >-
  ...
  emits a single buildable phase plan: the seven-line spine (Goal, In scope, Out of scope, Doctrine
...
4. Emit one phase plan in the phase-plan format the skill points to — the seven-line spine plus any
...
runs nc-750-review on your phase plan, and an implementer builds it.
